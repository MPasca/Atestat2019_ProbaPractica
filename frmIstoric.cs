...
namespace atestat
{
    public partial class frmIstoric : Form
    {
        public frmIstoric()
        {
            ...
            while (r.Read())
            {
                grdCarti.Rows.Add(r["codImprumut"].ToString(), r["codCarte"].ToString(), r["titlu"].ToString(), r["autor"].ToString(), r["codCititor"].ToString(), r["nume"].ToString(), r["prenume"].ToString(),r["data"].ToString(),r["return"].ToString());
            }
            r.Close();
        ...
        {
            (this.MdiParent as frmMain).fIstoric= null;
            Close();
        }
    }
}
